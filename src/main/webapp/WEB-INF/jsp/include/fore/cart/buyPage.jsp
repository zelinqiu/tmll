...
<div class="buyPageDiv">
  <!-- 点击提交之后，跳转到forecreateOrder，即生成订单 -->
		...
		<div>
			<table class="addressTable">
				<tr>
					...
					<td><textarea name="address" placeholder="尽量输入详细地址信息"></textarea></td>
				</tr>
				<tr>
					<td>邮政编码<span class="redStar">*</span></td>
					<td><input  name="post" placeholder="不清楚可填写000000" type="text"></td>
				</tr>
				<tr>
			...
			<thead>
				<tr>
					<th colspan="2" class="productListTableFirstColumn">
						...
						<a class="taobaoLink" href="#nowhere"><span class="wangwangGif"></span></a>
					</th>
					<th>单价</th>
					<th>数量</th>
					<th>小计</th>
