...
$(function(){
    $("a.deleteOrderItem").click(function(){
        ...
        //下面显示的额modal是存在与fore/modal位置的jsp代码
        $("#deleteConfirmModal").modal('show');
    });
    //如果点击了按钮确认删除，进入这个函数。在modal中，确认删除按钮的class=deleteConfirmButton
    ...
    $('#deleteConfirmModal').on('hidden.bs.modal', function (e) {
        if(deleteOrderItem) {
        	//如果点击确定删除，则执行foredeleteOrderItem
            var page="foredeleteOrderItem";
            $.post(page, {"oiid":deleteOrderItemid},
                    function(result){
                        if("success"==result){
