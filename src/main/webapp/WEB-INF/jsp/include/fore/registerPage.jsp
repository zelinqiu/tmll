...
$(function(){
    ...
    //下面的整个功能的class都是registerForm，因此这个js表示的是整个提交功能
...
<div class="registerDiv">
    ...
    <table class="registerTable" align="center">
        ...
        <tr>
            ...
            <td class="registerTableRightTD"><input id="repeatpassword" type="password"   placeholder="请再次输入你的登录密码" > </td>
        </tr>
                 
        <tr>
            <td colspan="2" class="registerButtonTD">
				
				<!-- 这里不加上这个href="registerSuccess.jsp也是可以运行的 -->
                <!-- <a href="registerSuccess.jsp"><button>提   交</button></a> -->
                <a><button>提   交</button></a>
            </td>
        </tr>            
    </table>
</div>
